...
@AutoValue
public abstract class TestClassBundled {

    public static TestClassBundled create(Bundle bundle, Gson gson) {
        return AutoValue_TestClassBundled.unbundle(bundle, gson);
    }
